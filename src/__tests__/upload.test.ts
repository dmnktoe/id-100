...
describe("deleteSessionUpload", () => {
  ...
  it("should delete session upload when confirmed", async () => {
    ...
    expect(window.confirm).toHaveBeenCalledWith(
      "Upload wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden."
    );
...
describe("endSession", () => {
  ...
  it("should end session when confirmed", async () => {
    ...
    expect(window.confirm).toHaveBeenCalledWith(
      "Session wirklich beenden? Das Werkzeug wird zurückgesetzt und kann an den nächsten Spieler weitergegeben werden."
    );
